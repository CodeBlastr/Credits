...
class CreditsSchema extends CakeSchema {
	...
	public $credits = array(
		...
		'credit_type' => array('type' => 'string', 'null' => true, 'default' => NULL, 'length' => 100, 'collate' => 'utf8_general_ci', 'comment' => 'Allows a site to have multiple credit types with different values.  Type values will be a system setting.', 'charset' => 'utf8'),
		...
		'value' => array('type' => 'float', 'null' => true, 'default' => '0', 'comment' => 'A convenience and performance field for easily finding the dollar value of this credit record.'),
